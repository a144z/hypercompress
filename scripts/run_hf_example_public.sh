#!/bin/bash
# Example with publicly available models (no auth required)
# Options: microsoft/phi-2, microsoft/phi-1_5, google/gemma-2b, meta-llama/Llama-2-7b-hf (requires request approval)
